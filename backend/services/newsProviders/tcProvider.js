...
// ============================================================
// ?? B�hoLex | Provider Tribunal Constitucional (TC)
...
// - Normaliza t�tulo, resumen, enlace, imagen, fecha, fuente, tipo, especialidad
// - Filtros locales: since (ISO o Date) y q (b�squeda simple)
// ============================================================
...
async function fetchNoticias({ max = 10, q = "", since = null } = {}) {
  ...
  // El TC ha usado /noticias, /noticias_tc, e incluso categor�as
  const candidates = [
    `${base}/noticias_tc/`,
    `${base}/noticias/`,
