...
function parseRSSItem(block) {
  ...
  return {
    ...
    fuente: "OEA",
    tipo: "juridica",
    especialidad: "internacional", // OEA ? DDHH / internacional p�blico (si quieres: clasificar por keywords)
    lang: "es",
  };
}
...
async function fetchNoticias({
  ...
  lang = "all",
  since = null,
  // especialidad (opcional, no filtramos duro aqu�)
} = {}) {
  try {
    let raw = [];
