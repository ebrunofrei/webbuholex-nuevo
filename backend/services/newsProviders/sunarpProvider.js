...
import {
  fetchRSS,         // ? aseg�rate de exportarlo en _helpers.js
  toISODate,
  normalizeText,
  proxifyMedia,
} from "./_helpers.js";
...
/** Filtro local por b�squeda simple */
...
async function fetchNoticias({ max = 10, q = "", since = null } = {}) {
  ...
  for (const url of feeds) {
    try {
      ...
      console.warn("SUNARP provider feed fall�:", url, err?.message || err);
    }
  }
