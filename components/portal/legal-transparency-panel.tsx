    ...
    <div className={styles.backdrop}>
      <div ref={dialogRef} className={styles.legalPanel} role="dialog" aria-modal="true" aria-labelledby="legal-panel-title">
        ...
        <div className={styles.legalColumns}>
          ...
          <section><h3>Centro legal</h3><ul><li>Política de Privacidad</li><li>Términos y Condiciones</li><li>Política de Cambios y Devoluciones</li><li><Link href="/libro-de-reclamaciones">Libro de Reclamaciones</Link><br /><small>Canal disponible para el registro de reclamos y quejas.</small></li><li>Aviso de Cookies</li><li>Licencias de uso</li></ul></section>
